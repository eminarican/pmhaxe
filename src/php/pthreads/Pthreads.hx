...
class Pthreads {
	...
	private static inline function get_PTHREADS_INHERIT_ALL(): Int {
		return Syntax.code("PTHREADS_INHERIT_ALL_NONE");
	}
	...
	private static inline function get_PTHREADS_INHERIT_NONE(): Int {
		return Syntax.code("PTHREADS_INHERIT_NONE");
	}
	...
	private static inline function get_PTHREADS_INHERIT_INI(): Int {
		return Syntax.code("PTHREADS_INHERIT_INI");
	}
	...
	private static inline function get_PTHREADS_INHERIT_CONSTANTS(): Int {
		return Syntax.code("PTHREADS_INHERIT_CONSTANTS");
	}
	...
	private static inline function get_PTHREADS_INHERIT_CLASSES(): Int {
		return Syntax.code("PTHREADS_INHERIT_CLASSES");
	}
	...
	private static inline function get_PTHREADS_INHERIT_FUNCTIONS(): Int {
		return Syntax.code("PTHREADS_INHERIT_FUNCTIONS");
	}
	...
	private static inline function get_PTHREADS_INHERIT_INCLUDES(): Int {
		return Syntax.code("PTHREADS_INHERIT_INCLUDES");
	}
	...
	private static inline function get_PTHREADS_INHERIT_COMMENTS(): Int {
		return Syntax.code("PTHREADS_INHERIT_COMMENTS");
	}
	...
	private static inline function get_PTHREADS_ALLOW_HEADERS(): Int {
		return Syntax.code("PTHREADS_ALLOW_HEADERS");
	}
}
